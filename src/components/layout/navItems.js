...
// drift out of sync. All 9 stages plus Loans (Stage 11) are live, so every
// item is reachable. `shortLabel` is only used by the mobile tab bar, which
// has far less room per item than the sidebar's full-width rows.
export const NAV_ITEMS = [
  ...
  { key: "loans", label: "Loans", shortLabel: "Loans", icon: CreditCard },
...
export const MOBILE_SECONDARY_KEYS = ["hiring", "realestate", "tax", "loans", "rivals"];
