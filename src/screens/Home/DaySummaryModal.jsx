    ...
    <Modal open={open} onClose={onClose} title={`Day ${summary.day} Summary`} className="max-w-sm">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <SummaryRow label="Dividends" amount={summary.dividends} currency={currency} />
          ...
          <SummaryRow label="Auto-Deposit" amount={summary.autoDeposit} currency={currency} isExpense />
